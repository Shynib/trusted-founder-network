          ...
          <div className="max-w-md mx-auto">
            <Card className="border-gold-accent/20 shadow-premium">
              <CardHeader className="text-center">
                ...
                <CardDescription>
                  Sign in to your exclusive membership
                </CardDescription>
              </CardHeader>
              ...
              <CardContent className="space-y-6">
                ...
                <form className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <Link to="/forgot-password" className="text-sm text-gold-accent hover:underline">
                        Forgot password?
                      </Link>
                    </div>
                    <div className="relative">
                ...
                <div className="text-center">
                  <p className="text-sm text-muted-foreground">
                    ...
                    <Link to="/signup" className="text-gold-accent hover:underline font-medium">
